...
<article class="blogs">
    ...
    <aside class="right">
        <div class="rnav">
            <ul>
                <li class="rnav1"><a href="/download/" target="_blank">日記</a></li>
                <li class="rnav2"><a href="/newsfree/" target="_blank">程式人生</a></li>
                <li class="rnav3"><a href="/web/" target="_blank">欣賞</a></li>
