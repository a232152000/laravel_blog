			...
			<li>
				<h3><i class="fa fa-fw fa-clipboard"></i>內容管理</h3>
					<ul class="sub_menu">
						...
						<li><a href="{{url('admin/article')}}" target="main"><i class="fa fa-recycle"></i>文章列表</a></li>
					</ul>
			</li>
			<li>
				<h3><i class="fa fa-fw fa-cog"></i>系統設置</h3>
					<ul class="sub_menu" style="display: block">
						...
						<li><a href="{{url('admin/navs')}}" target="main"><i class="fa fa-navicon"></i>自定義導航</a></li>
						<li><a href="{{url('admin/config')}}" target="main"><i class="fa fa-fw fa-cog"></i>網站配置</a></li>
					</ul>
			</li>
			<li>
