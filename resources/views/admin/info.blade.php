...
@section('content')
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>時間</label><span><?php echo date('Y年m月d日 H時i分s秒')?></span>
                </li>
                <li>
                    <label>服務域名/IP</label><span>{{$_SERVER['SERVER_NAME']}} [ {{$_SERVER['SERVER_ADDR']}} ]</span>
                </li>
                <li>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>交流網站：</label><span><a href="#">http://www.google.com</a></span>
                </li>
            </ul>
        </div>
    </div>
